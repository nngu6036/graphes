...
def aligned_havel_hakimi_source(
    ...
    *,
    ...
    # This function is a legacy source-builder adapter. Keep its baseline
    # dependency lazy so importing the Rewiring MLP data/model modules does not
    # import DH-VAE+HH implementation code.
    from grapher.models.dhvae_hh.havel_hakimi import (
        construct_indexed_havel_hakimi,
    )
    ...
    source = construct_indexed_havel_hakimi(
        degrees,
        ensure_connected=ensure_connected,
